...
<body x-data="{ page: 'login', 'loaded': true, 'darkMode': false, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }" x-init="darkMode = JSON.parse(localStorage.getItem('darkMode'));
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <a href="#"
                                            class="text-brand-500 hover:text-brand-600 dark:text-brand-400 text-sm">Mot
                                            de passe oublié?</a>
                                    </div>
                            ...
                            <div class="mt-5">
                                <p
                                    ...
                                    <a href="{{ route('register') }}"
                                        class="text-brand-500 hover:text-brand-600 dark:text-brand-400">S'inscrire</a>
                                </p>
                            </div>
                        </div>
                    </div>
