<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-400">Gérez les comptes utilisateurs et leurs rôles</p>
        </div>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-gray-900 dark:text-white">
                                            {{ $user->name }}</div>
                                        @if ($user->id === auth()->id())
                                            <div class="text-xs text-blue-600 dark:text-blue-400">(Vous)</div>
                                        @endif
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    ...
                                    @if ($user->role->nom === 'Admin') bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200
                                    @elseif($user->role->nom === 'Gérant') bg-orange-100 text-orange-800 dark:bg-orange-900 dark:text-orange-200
                                    @elseif($user->role->nom === 'Caissier') bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                                <div class="flex space-x-4 text-xs">
                                    <span>{{ $user->ventes_count }} vente(s)</span>
                                    <span>{{ $user->approvisionnements_count }} appro(s)</span>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center space-y-3">
                                    ...
                                    <p class="text-gray-500 dark:text-gray-400 text-lg font-medium">Aucun utilisateur
                                        trouvé</p>
                                    <p class="text-gray-400 dark:text-gray-500 text-sm">Commencez par créer votre
                                        premier utilisateur</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
