    ...
    <div
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                <!-- Recherche -->
                <div class="relative">
                    <input type="text" wire:model.live.debounce.300ms="search" placeholder="Rechercher un lot..."
                ...
                <thead class="bg-gray-50 dark:bg-gray-800/50">
                    <tr>
                        <th class="px-6 py-3 text-left">
                            <button wire:click="sortBy('numero_lot')"
                        ...
                        <th class="px-6 py-3 text-left">
                            <button wire:click="sortBy('article_id')"
                                class="flex items-center gap-1 font-medium text-gray-900 dark:text-white hover:text-blue-600">
                                Article
                        ...
                        <th class="px-6 py-3 text-left">
                            <button wire:click="sortBy('ville_id')"
                                class="flex items-center gap-1 font-medium text-gray-900 dark:text-white hover:text-blue-600">
                                Ville
                        ...
                        <th class="px-6 py-3 text-left">
                            <button wire:click="sortBy('date_arrivee')"
                                class="flex items-center gap-1 font-medium text-gray-900 dark:text-white hover:text-blue-600">
                                Date Arrivée
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    @forelse($lots as $lot)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-gray-900 dark:text-white">{{ $lot->approvisionnement->fournisseur }}
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex flex-col">
                                    ...
                                    <div class="w-full bg-gray-200 rounded-full h-2 dark:bg-gray-700 mt-1">
                                        <div class="bg-blue-600 h-2 rounded-full"
                                            style="width: {{ $lot->quantite_initiale > 0 ? ($lot->quantite_restante / $lot->quantite_initiale) * 100 : 0 }}%">
                                        </div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex flex-col text-sm">
                                    <span class="text-gray-600 dark:text-gray-400">Achat:
                                        {{ number_format($lot->prix_achat, 0, ',', ' ') }} FC</span>
                                    <span class="text-gray-900 dark:text-white font-medium">Vente:
                                        {{ number_format($lot->prix_vente, 0, ',', ' ') }} FC</span>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                        ...
                        <tr>
                            <td colspan="8" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">Aucun lot trouvé
                                    </h3>
                                    <p class="text-gray-500 dark:text-gray-400 mb-4">Commencez par créer votre premier
                                        lot.</p>
                                    <button wire:click="openModal"
                                        class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-lg font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:bg-blue-700 active:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition ease-in-out duration-150">
    ...
    @if ($showModal)
        <div class="fixed inset-0 z-50 overflow-y-auto" x-data="{ show: @entangle('showModal') }" x-show="show" x-cloak>
            <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div
                    class="inline-block w-full max-w-2xl p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl dark:bg-gray-800">
                    ...
                    <form wire:submit="save">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="md:col-span-2">
                                <h4 class="text-md font-medium text-gray-900 dark:text-white mb-3">Informations de
                                    l'approvisionnement</h4>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" wire:model="date_approvisionnement"
                            ...
                            <div>
                                ...
                                <input type="text" wire:model="fournisseur" placeholder="Nom du fournisseur"
                            ...
                            <!-- Informations du lot -->
                            <div class="md:col-span-2">
                                <h4 class="text-md font-medium text-gray-900 dark:text-white mb-3 mt-4">Informations du
                                    lot</h4>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" wire:model="numero_lot" placeholder="Ex: LOT-2024-001"
                                    class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400">
                                @error('numero_lot')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="date" wire:model="date_arrivee"
                                    class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                                @error('date_arrivee')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="number" wire:model="quantite_initiale" min="1" placeholder="0"
                                    class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400">
                            ...
                            @if ($editMode)
                                <div>
                                    ...
                                    <input type="number" wire:model="quantite_restante" min="0"
                                        placeholder="0"
                                        class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400">
                            ...
                            <div>
                                ...
                                <input type="number" wire:model="prix_achat" step="0.01" min="0"
                                    placeholder="0.00"
                                    class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400">
                                @error('prix_achat')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <input type="number" wire:model="prix_vente" step="0.01" min="0"
                                    placeholder="0.00"
                                    class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400">
                                @error('prix_vente')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
