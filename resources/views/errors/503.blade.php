...
<body x-data="{ page: 'page503', 'loaded': true, 'darkMode': false, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }" x-init="darkMode = JSON.parse(localStorage.getItem('darkMode'));
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'dark bg-gray-900': darkMode === true }">
    ...
    <div class="relative z-1 flex min-h-screen flex-col items-center justify-center overflow-hidden p-6">
        ...
        <div class="mx-auto w-full max-w-[242px] text-center sm:max-w-[492px]">
            ...
            <img src="{{ asset('images/error/503.svg') }}" alt="503" class="dark:hidden" />
            <img src="{{ asset('images/error/503-dark.svg') }}" alt="503" class="hidden dark:block" />
        ...
        <p class="absolute bottom-6 left-1/2 -translate-x-1/2 text-center text-sm text-gray-500 dark:text-gray-400">
            &copy; <span id="year"></span> - Lovely
        </p>
    </div>
    @includeIf('partials.footer-js')
</body>
