...
<head>
    ...
    <title>
        500 Error Page | Lovely
    </title>
    @include('partials.header-link')
</head>

<body x-data="{ page: 'page500', 'loaded': true, 'darkMode': false, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }" x-init="darkMode = JSON.parse(localStorage.getItem('darkMode'));
