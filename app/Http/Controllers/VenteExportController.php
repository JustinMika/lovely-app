...
class VenteExportController extends Controller
{
    public function exportPdf(Request $request)
    {
        ...
        $pdf->Cell(40, 6, number_format($montantTotal, 0, ',', ' ') . ' FC', 0, 1, 'L');
        ...
        $pdf->Cell(40, 6, number_format($montantPaye, 0, ',', ' ') . ' FC', 0, 1, 'L');
        ...
        $pdf->Cell(40, 6, number_format($montantRestant, 0, ',', ' ') . ' FC', 0, 1, 'L');
        ...
        $pdf->Cell(40, 6, number_format($beneficeTotal, 0, ',', ' ') . ' FC', 0, 1, 'L');
        $pdf->SetFont('Arial', '', 10);
        ...
        $pdf->Cell(30, 8, 'Total (FC)', 1, 0, 'C', true);
        $pdf->Cell(30, 8, 'Paye (FC)', 1, 0, 'C', true);
        $pdf->Cell(30, 8, 'Restant (FC)', 1, 0, 'C', true);
        ...
        $pdf->Cell(0, 5, 'Ce rapport contient ' . $totalVentes . ' vente(s) pour un montant total de ' . number_format($montantTotal, 0, ',', ' ') . ' FC', 0, 1, 'L');
        $pdf->Cell(0, 5, 'Benefice total realise: ' . number_format($beneficeTotal, 0, ',', ' ') . ' FC', 0, 1, 'L');
