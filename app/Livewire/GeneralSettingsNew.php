...
class GeneralSettingsNew extends Component
{
	...
	public function resetToDefaults()
	{
		...
		try {
			...
			$this->company_name = 'Lovely Boutique';
			$this->company_address = 'Nk, Goma';
			$this->company_phone = '0855555555';
			$this->company_email = ' admin@lovely-app.com';
			$this->currency_symbol = 'FC';
